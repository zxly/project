          ...
          <div class="main main-bg clearfix">
               ...
               <div class="info-right joint_venture fr w980 pr20">
               		...
               		<a href="javascript:;" class="show_block btn add_partner_btn f14 mt20 bd_d lh24 clearfix">
               			<img src="${ctx }/static/web/image/globle/admin-add-ico.png" class="fl mr20"/>添加图文广告
               		</a>
                    
                    <div class="bg_fa bd_d mt15 p20">    
                    	<form class="clearfix" id="searchForm" action="${ctx}/club/showAdvertise/list" method="post" >                  
                            <!-- <label for="all_checked" class="fl all_checked_label pr10"><input type="checkbox" class="fl mt12 mr20 join_all_checked" id="all_checked">
                            ...
                            <div class="clearfix mb15">
	    						...
	    						<div class="fl form_group bd_c bg_white pl15 mr10">
	                                <span class="fl lh32">标题:</span>
	                                <input type="text" name="title" class="form_control bdnone w120" />
	                            </div>
	                            <div class="fl form_group bd_c bg_white pl15 mr10 ">
	                                <span class="fl lh32">副标题:</span>
	                                <input type="text" name="subtitle" class="form_control bdnone w220" />
	                            </div>
...
<script type="text/javascript" src="${ctx }/static/web/js/showAdvertise/showAdvertise_list.js"></script>
</html>
