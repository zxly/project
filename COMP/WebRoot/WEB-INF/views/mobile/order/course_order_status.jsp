...
<head>
	...
	<link rel="stylesheet" href="${ctx }/static/mobile/css/order/course_order_status.css?v=${version}" type="text/css"/>
</head>
<body>
<div class="content">
			...
			<form>
				<div class="mtb15 bd_d2_tb bg_w plr10 ptb15">
					<div class="ptb10 t-css">
						<c:if test="${courseOrderVo.payStatus eq 'YFK' }">
							<span class="iconfont icon-duigou f_30 t_green wp30 t_r t-cell-css pr10 border_box"></span>
							<div class="wp70 t-cell-css t_l pt6">付款成功！您已成功订场</div>
						</c:if>
						<c:if test="${courseOrderVo.payStatus eq 'DFK' }">
							<div class="wp70 t-cell-css t_l pt6 t_red">付款失败！</div>
						</c:if>
					</div>
					<!-- <p><b>温馨提示：</b>请耐心等待，商家已及时进行处理，正在进行退款流程。</p> -->
				</div>
				<div class="mtb15 plr10">
					<input type="button" class="btn btn_organe wp100 back_order" dataId="${courseOrderVo.id }" value="返回订单">
				</div>
