...
<head>
	...
	<link rel="stylesheet" href="${ctx }/static/mobile/css/user/course/user_course.css?v=${version}" type="text/css" />
</head>
<body>
<div class="content">
	<!-- main - start -->
		...
		<div class="wrap">
            ...
            <div class="favourable bg_w">
                <div class="favourable_nav bg_white clearfix">
                    <a href="javascript:;" class="ptb15 js-nav active">我的订场</a>
...
<script type="text/javascript" src="${ctx }/static/mobile/js/user/course/user_course.js?v=${version}"></script>
</body>
</html>
