...
<head>
	...
	<link rel="stylesheet" href="${ctx }/static/mobile/css/user/game/user_game.css?v=${version}" type="text/css" />
</head>
<body>
<div class="content">
	<!-- main - start -->
		...
		<div class="wrap">
            ...
            <div class="favourable bg_w">
                <div class="favourable_nav bg_white clearfix">
                    <a href="javascript:;" class="ptb15 js-nav active">我的比赛</a>
...
<script type="text/javascript" src="${ctx }/static/mobile/js/user/game/user_game.js?v=${version}"></script>
</html>
