$(function(){
	...
	$('body').on('click','.add',function(){
		var newTr='<tr class="speclist">'+
						'<td style="display: none;"><input class="t_c w80 form_control specId"  type="text" value="0"/></td>'+
						'<td><input class="t_c w80 form_control specName" type="text"/></td>'+
						'<td><input class="t_c w80 form_control goodsNum" type="text"/></td> '+
						'<td><input class="t_c w80 form_control price" type="text"/></td><td>'+
						'<input class="t_c w80 form_control vipPrice" type="text"/></td>'+
						'<td><a class="t_darkblue f14 del" href="javascript:;">删除</a></td>'+
					'</tr>';
